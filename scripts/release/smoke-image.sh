...
export LLMTW_COMPOSE_TEMPORAL_PORT="${LLMTW_COMPOSE_TEMPORAL_PORT:-0}"
export LLMTW_COMPOSE_TEMPORAL_UI_PORT="${LLMTW_COMPOSE_TEMPORAL_UI_PORT:-0}"
export LLMTW_COMPOSE_REDIS_PORT="${LLMTW_COMPOSE_REDIS_PORT:-0}"
export LLMTW_COMPOSE_HEALTH_PORT="${LLMTW_COMPOSE_HEALTH_PORT:-0}"
export LLMTW_COMPOSE_METRICS_PORT="${LLMTW_COMPOSE_METRICS_PORT:-0}"
