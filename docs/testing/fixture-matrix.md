...
lowering/lifting (including priority downgrade), classified-error redaction,
and captured SSE decoding and assembly across deterministic fragment boundaries.
The Bedrock Converse suite
...
streaming. Its three-class matrix includes both priority/priority and
priority/standard downgrade outcomes and is pinned to Amazon Nova Pro
